...
try {
	...
	/*
	 * @When("user enters charaters in {string}field") public void
	 * user_enters_charaters_in_field(String sendto) { try {
	 * driver.findElement(By.xpath("//input[@class='select2-search__field']")).
	 * sendKeys(sendto); } catch(Exception e)
	 * 
...
//		    	editable.sendKeys("hdicjbrv1iuugiu4igf");
